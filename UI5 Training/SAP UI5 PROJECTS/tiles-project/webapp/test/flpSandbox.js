		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tiles App",
									"targetURL": "#tilesproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tilesproject-display": {
								"semanticObject": "tilesproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tilesproject",
									"url": sap.ui.require.toUrl("tilesproject")
								}
							}
						}
					}
